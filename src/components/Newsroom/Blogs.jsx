      ...
      <div className="blog-banner-wrapper">
        <div className="blog-banner">
          <div className="blog-banner-text">
            <h3>
              Get the latest Press Releases <br /> in the Newsroom to stay{" "}
              <br /> up to date...
            </h3>
          </div>
        </div>
          ...
          <article id="press-contact-container">
            <div className="profile-card">
              <div className="profile-photo-box">
                <img
                  src="https://res.cloudinary.com/dx6qjxz55/image/upload/v1711201669/profile-1_tsay2e.avif"
                  alt="Profile photo"
              ...
              <div className="profile-info">
                ...
                <div className="profile-contact">
                  <a href="mailto:fashion.store@info.org" target="_blank">
                    WRITE A MAIL
                  </a>
                </div>
              </div>
            ...
            <div className="profile-card">
              <div className="profile-photo-box">
                <img
                  src="https://res.cloudinary.com/dx6qjxz55/image/upload/v1711201669/profile-2_fnjmjf.avif"
                  alt="Profile photo"
                  className="profile-img"
                />
              </div>
