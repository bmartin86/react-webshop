        ...
        <div className="single-blog-main-flexbox">
          ...
          <article id="main-blog-content">
            ...
            <div className="blog-header">
              <p id="blog-header-intro">{blogPost.contentIntro}</p>
            ...
            <div className="article-main-text">
              <div>{blogPost.contentMainTop}</div>
              <div>{blogPost.contentMain}</div>

              {/* <!-- klasa za border --> */}
              <div id="border-bottom-div">{blogPost.contentMainBottom}</div>

              <div id="padding-top-div">{blogPost.contentOutro}</div>
              <div className="blog-text-author">{blogPost.author}</div>
            </div>
          </article>
