function ReturnPolicy () {
  return (
    ...
    <p>Thank you for shopping at FASHION STORE.</p>
    ...
    <ul>
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to FASHION STORE.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to FASHION STORE, accessible from <a href="www.fashion-store.com" rel="external nofollow noopener" target="_blank">https:newstyle.com</a></p>
    </li>
    <li>
    ...
    <ul>
    <li>By email: fashion.store@info.org</li>
    </ul>
