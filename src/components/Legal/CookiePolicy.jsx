function CookiePolicy () {
  return (
    <>
    <h2>COOKIE POLICY FOR FASHION STORE</h2>

    <p>This is the Cookie Policy for FASHION STORE, accessible from www.fashion-store.com</p>
    ...
    <ul>
    <li>Email: fashion.store@info.org</li>
